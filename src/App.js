...
const refreshPage = ()=>{
  ...
  return (
    <div className="App nftapp">
        <nav class="navbar navbarfont navbarglow navbar-expand-md navbar-dark bg-black mb-4">
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            <a class="navbar-brand px-1" style={{ fontWeight: "800", fontSize: '25px' }} href="#"></a><img src="logo.jpg" width="7%" />
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 px-3 mb-md-0" style={{ fontSize: "25px" }}>
                ...
                <li class="nav-item">
                  <a class="nav-link">Sell Assets</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className='col'>
      <h1 className='n2dtitlestyle mt-3'>Block Republic Group Dashboard</h1>
      <Button onClick={refreshPage} style={{ backgroundColor: "#000000", boxShadow: "1px 1px 5px #000000" }}>Refresh Dashboard</Button>
      </div>
        <div className='row mt-3'>
        <div className='col mt-4 ml-3'>
        <img src="polygon.png" width={'60%'}></img>
      </div>
      <div className='col mt-1 mr-5'>
      <img src="logo1.png" width={'60%'}></img>
      </div>
      ...
      <img src="ethereum.png" width={'60%'}></img>
        ...
        <div className='container container-style'>
          ...
          <form>
            ...
            >
              <Button style={{backgroundColor:"#000000", boxShadow: "1px 1px 10px #fff" }} value="1">1</Button>
              <Button style={{backgroundColor:"#000000", boxShadow: "1px 1px 10px #fff" }} value="2">2</Button>
              <Button style={{backgroundColor:"#000000", boxShadow: "1px 1px 10px #fff" }} value="3">3</Button>
              <Button style={{backgroundColor:"#000000", boxShadow: "1px 1px 10px #fff" }} value="4">4</Button>
              <Button style={{backgroundColor:"#000000", boxShadow: "1px 1px 10px #fff" }} value="5">5</Button>
            </ButtonGroup>
            ...
            <div className="col ">
                <Button className="button-style" onClick={mint0} style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000", backgroundColor:"#000000" }}>
                  <img src={"logo.jpg"} width="70%" />
                </Button>
              </div>
              <div className="col">
                <Button className="button-style" onClick={mint1} style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000", backgroundColor:"#000000" }}>
                  <img src="usdt.png" width="70%" />
                </Button>
              </div>
              <div className="col">
                <Button className="button-style" onClick={mintnative} style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000", backgroundColor:"#000000" }}>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form  style={{ fontFamily: "SF Pro Display" }} >
              <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>Block Republic Group NFT Staking Vault </h2>
              ...
              <div className="row px-3">
                <div className="col">
                  <form class="stakingrewards" style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                    ...
                    <h6 style={{ color: "#FFFFFF" }}>Verify Rented Amount</h6>
                    ...
                    <table className='table mt-3 mb-5 px-3 table-dark'>
                      <tr>
                        <td style={{ fontSize: "19px" }}>Your Rented NFTs:
                      ...
                      <tr>
                        <td style={{ fontSize: "19px" }}>Total Rented NFTs:
                      ...
                      <tr>
                        <td style={{ fontSize: "19px" }}>UnRent All Staked NFTs
                          <Button onClick={unstakeall} className='mb-3' style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }}>UnRent All</Button>
                        </td>
                      </tr>
                    </table>
                  </form>
                  </div>
                  <img className="col-lg-5" src="image4.webp"/>
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", fontFamily: "SF Pro Display" }}>
                      ...
                      <Button onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned BRG Rewards</Button>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    <div style={{ fontSize: '25px', borderRadius: '14px', color: "#ffffff", fontWeight: "300" }}>BRG Real Estate NFT Renting Pool Active Rewards</div>
                    <table className='table px-3 table-bordered table-dark'>
                      ...
                      <tr>
                          ...
                          <td class="amount" data-test-id="rewards-summary-ads">
                            <span class="amount">0.50</span>&nbsp;<span class="currency">BRGT</span>
                          </td>
                          <td class="exchange">
                            <span class="amount">2</span>&nbsp;<span class="currency">BRG Avatar NFTs/M</span>
                          </td>
                        </tr>
                        <tr className='exchange'>
                          <td>Residential Collection</td>
                          <td class="amount" data-test-id="rewards-summary-one-time"><span class="amount">1</span>&nbsp;<span class="currency">BRGT+</span>
                          </td>
                          <td class="exchange">
                            <span class="amount">25 BRG Real Estate NFTs/M or </span>
                            <span class="currency">100 BRDT/M</span>
                          </td>
                        </tr>
                        <tr>
                          <td>Commercial Collection</td>
                          <td class="amount" data-test-id="rewards-summary-ac">
                            <span class="amount">2.50</span>&nbsp;<span class="currency">BRGT</span>
                          </td>
                          <td class="exchange"><span class="amount">10</span>&nbsp;<span class="currency">BRG Real Estate NFTs/M</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <div class="header">
                      <div style={{ fontSize: '25px', borderRadius: '14px', fontWeight: '300' }}>BRGT Rent Pools</div>
                      <table className='table table-bordered table-dark' style={{ borderRadius: '14px' }} >
                        <thead className='thead-light'>
                          <tr>
                            <th scope="col">Pools</th>
                            <th scope="col">Daily Earnings</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>Rent BRGT to Earn BRGT</td>
                            <td class="amount" data-test-id="rewards-summary-ads">
                              <span class="amount">0.01</span>&nbsp;<span class="currency">Per BRGT</span>
                            </td>
                          </tr>
                          <tr>
                            <td>Rent BRDT to Earn BRGT+</td>
                            <td class="amount" data-test-id="rewards-summary-ac">
                              <span class="amount">0.005</span>&nbsp;<span class="currency">Per BRGT</span>
                            </td>
                          </tr>
                          </tbody>
                      </table>
