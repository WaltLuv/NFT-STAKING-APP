...
const moralisapikey = "axvkg8H31OYNVXDzr4M3Rsu4tuylAG5HEqQqg127xALI7t50LkA7VJK8wCVpwf2S";
                      ...
                      <div className="card nft-card mt-3 mb-3" key={i} >
                        ...
                        <div className="card-caption col-12 p-0">
                          <div className="card-body">
                            <h5 className="mb-0">Block Republic Real Estate NFT Collection #{nft.tokenId}</h5>
                            <h5 className="mb-0 mt-2">Status<p style={{ color: "#00FF00", fontWeight: "bold" }}>Ready to Rent</p></h5>
                            <div className="card-bottom d-flex justify-content-between">
                              <input key={i} type="hidden" id='stakeid' value={nft.tokenId} />
                              <Button style={{ marginLeft: '2px', backgroundColor: "#ffffff10" }} onClick={stakeit}>Rent It</Button>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {nftstk.map((nft, i) => {
                      ...
                      return (
                        ...
                        <div className="card stakedcard mt-3 mb-3" key={i} >
                          <div className="image-over">
                          <img style={{position:'absolute',top:'0.05rem',width:'90px'}} src='logo.jpg'></img>
                            <img className="card-img-top" src={nftpng + nft.tokenId + '.png'} alt="" />
                          </div>
                          <div className="card-caption col-12 p-0">
                            <div className="card-body">
                              <h5 className="mb-0">Block Republic Real Estate NFT Collection #{nft.tokenId}</h5>
                              <h5 className="mb-0 mt-2">Status<p style={{ color: "#00FF00", fontWeight: "bold" }}>Currently Rented</p></h5>
                              <div className="card-bottom d-flex justify-content-between">
                                <input key={i} type="hidden" id='stakeid' value={nft.tokenId} />
                                <Button style={{ marginLeft: '2px', backgroundColor: "#ffffff10" }} onClick={unstakeit}>UnRent It</Button>
                              </div>
                            </div>
                          </div>
                        </div>
